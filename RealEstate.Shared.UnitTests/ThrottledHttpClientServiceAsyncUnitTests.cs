...
namespace RealEstate.Shared.UnitTests
{
    public class ThrottledHttpClientServiceAsyncUnitTests
    {
        ...
        public async Task GetAsyncTest()
        {
            ...
            var throttledHttpClientServiceAsync = new ThrottledHttpClientServiceAsync<IEnumerable<string>>(mockHttpClientService.Object, new RealEstateConfiguration { RealEstateApiKey = "key", HttpRequestInitialCount = 10, HttpRequestMaxCount = 10 });
